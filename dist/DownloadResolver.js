...
class DownloadResolver {
    constructor(botUsername, config = {}) {
        this.time = 0;
        this.count = 0;
    ...
    async downloadSong(url, filenameWithoutExtension = DownloadResolver.UUID()) {
        ...
        const downloadPromise = new Promise(async (resolve, reject) => {
            ...
            while (!found) {
                ...
                const history = await DownloadResolver.client.invoke(new Api.messages.GetHistory({
